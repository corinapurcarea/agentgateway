...
func (x *BackendPolicySpec) GetMcpExtAuthz() *TrafficPolicySpec_ExternalAuth {
	if x != nil {
		if x, ok := x.Kind.(*BackendPolicySpec_McpExtAuthz); ok {
			return x.McpExtAuthz
		}
	}
	return nil
}
...
type BackendPolicySpec_McpExtAuthz struct {
	McpExtAuthz *TrafficPolicySpec_ExternalAuth `protobuf:"bytes,14,opt,name=mcp_ext_authz,json=mcpExtAuthz,proto3,oneof"`
}
...
func (*BackendPolicySpec_McpExtAuthz) isBackendPolicySpec_Kind() {}
...
const file_resource_proto_rawDesc = "" +
	...
	"backendTcp\x12_\n" +
	"\rmcp_ext_authz\x18\x0e \x01(\v29.agentgateway.dev.resource.TrafficPolicySpec.ExternalAuthH\x00R\vmcpExtAuthz\x1a\x87\"\n" +
	"\x02Ai\x12^\n" +
...
var file_resource_proto_depIdxs = []int32{
	...
	98,  // 107: agentgateway.dev.resource.BackendPolicySpec.mcp_ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[45].OneofWrappers = []any{
		...
		(*BackendPolicySpec_McpExtAuthz)(nil),
	}
